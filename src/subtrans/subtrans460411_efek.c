...
int ics_proc_460411_efek(char *send_buff,char *recv_buff)
{
  /*说明：send_buff-上传报文；
          recv_buff-下传报文;
 ...
 */
  ...
  char      ics_request_i_buff[517];
  char      ics_response_n_buff[335];
...
flog( STEP_LEVEL,"--482101 接收[%s]-------------------------------",send_buff);
 ...
 /* 注意：填充数据最好按照结构定义先后顺序，以免出现数据覆盖问题 */
  ...
  strcpy(pICS_TIA->TTxnCd,"460411");
  strcpy(pICS_TIA->FeCod,"460411");
  ...
  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"SFFS",tmpvalue);
  strcpy(pICS_REQUEST_I->SFFS,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"FYLX",tmpvalue);
  strcpy(pICS_REQUEST_I->FYLX,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"DWBM",tmpvalue);
  strcpy(pICS_REQUEST_I->DWBM,tmpvalue);
  ...
  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"YDDZ",tmpvalue);
  strcpy(pICS_REQUEST_I->YDDZ,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"KKZH",tmpvalue);
  strcpy(pICS_REQUEST_I->KKZH,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"KKZHMC",tmpvalue);
  strcpy(pICS_REQUEST_I->KKZHMC,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"BFJFBZ",tmpvalue);
  strcpy(pICS_REQUEST_I->BFJFBZ,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"ZWLSH",tmpvalue);
  strcpy(pICS_REQUEST_I->ZWLSH,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"DFNY",tmpvalue);
  strcpy(pICS_REQUEST_I->DFNY,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"QFJE",tmpvalue);
  strcpy(pICS_REQUEST_I->QFJE,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"BJ",tmpvalue);
  strcpy(pICS_REQUEST_I->BJ,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"WYJ",tmpvalue);
  strcpy(pICS_REQUEST_I->WYJ,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"VchTyp",tmpvalue);
  strcpy(pICS_REQUEST_I->VchTyp,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"VchNo",tmpvalue);
  strcpy(pICS_REQUEST_I->VchNo,tmpvalue);

  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"BilDat",tmpvalue);
  strcpy(pICS_REQUEST_I->BilDat,tmpvalue);
  ...
  memset(tmpvalue, 0, sizeof(tmpvalue));
  getValueOfStr(send_buff,"PinBlk",tmpvalue);
  strcpy(pICS_REQUEST_I->PinBlk,tmpvalue);
