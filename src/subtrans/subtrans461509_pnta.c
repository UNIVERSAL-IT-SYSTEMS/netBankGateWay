...
RETURN:
     ...
     ||memcmp(pICS_TOA->RspCod,"SC0000",sizeof(pICS_TOA->RspCod))==0)/*成功*/
  {
    ...
    /* 注意，<br>是页面显示的换行符号 */
      ...
      setValueOfStr(recv_buff,"AdnCod",tmp_val_str);/*文书编号*/
      ...
      setValueOfStr(recv_buff,"FinAccIn",tmp_val_str);/*入账帐号*/
