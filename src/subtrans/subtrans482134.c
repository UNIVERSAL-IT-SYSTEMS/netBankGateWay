...
int ics_proc_482134(char *send_buff,char *recv_buff)
{
  /*说明：send_buff-上传报文；
          recv_buff-下传报文;
 ...
 */
  ...
  ICS_DEF_482134_I  *pICS_482134_I;
  ICS_DEF_482134_N  *pICS_482134_N;
  ICS_DEF_482134_E  *pICS_482134_E;

  char      ics_send_buff[LEN_ICS_PROC_BUF];
  char      ics_recv_buff[LEN_ICS_PROC_BUF];
  char      ics_482134i_buff[12];
  char      ics_482134n_buff[21];
  char      ics_482134e_buff[71];
...
/*
  ...
  memset(ics_482134i_buff,'\0',sizeof(ics_482134i_buff));
  memset(ics_482134n_buff,'\0',sizeof(ics_482134n_buff));
  memset(ics_482134e_buff,'\0',sizeof(ics_482134e_buff));
  memset(ics_tia_buff,'\0',sizeof(ics_tia_buff));
  memset(ics_toa_buff,'\0',sizeof(ics_toa_buff));
  memset(ics_482134o_buff, 0, sizeof(ics_482134o_buff));

  pICS_482134_I=(ICS_DEF_482134_I *)ics_482134i_buff;
  pICS_482134_N=(ICS_DEF_482134_N *)ics_482134n_buff;
  pICS_482134_E=(ICS_DEF_482134_E *)ics_482134e_buff;
  ...
  offset=offset+sizeof(ICS_DEF_TIA);
	...
	getValueOfStr(send_buff,"Provider_Code", tmpvalue);   /* 景区代码 */
  
  len=sizeof(ICS_DEF_482134_I);
  strcpy(pICS_482134_I->Provider_Code, tmpvalue);
  for(i=0;i<len;i++)
  {
    if(ics_482134i_buff[i]==0)
      ics_482134i_buff[i]=' ';
  }
	memcpy(ics_send_buff+offset, ics_482134i_buff, len);  
  offset=offset+len;
...
RETURN:
  ...
  /* 注意，<br>是页面显示的换行符号 */
      ...
      memcpy(ics_482134n_buff,ics_recv_buff+sizeof(ics_toa_buff),sizeof(ics_482134n_buff));

			memcpy(ics_482134o_buff, ics_recv_buff+sizeof(ics_toa_buff)+sizeof(ics_482134n_buff),  sizeof(ics_recv_buff)-sizeof(ics_toa_buff)-sizeof(ics_482134n_buff));
      
      setValueOfStr(recv_buff,"display_zone","");
      for(i=0; i<strlen(ics_482134o_buff); i++){
      	if(ics_482134o_buff[i] == 0x0a || ics_482134o_buff[i] == 0x0d)
      		ics_482134o_buff[i] = ' ';
      }
      setValueOfStr(recv_buff,"jingquxingxi", ics_482134o_buff);
  ...
  { /*失败*/
      ...
      memcpy(ics_482134e_buff,ics_recv_buff+sizeof(ics_toa_buff),sizeof(ics_482134e_buff));
  ...
  flog( STEP_LEVEL,"**482134 返回[%s]******************************",recv_buff);
