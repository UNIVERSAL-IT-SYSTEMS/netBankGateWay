...
** (c) Copyright Sybase, Inc. 1998-2001.
** All rights reserved
*/
...
/* Local Univarchar */
insert into spt_jdatatype_info values
(155, 'univarchar', 35, null, null, null, null, '''', '''',
          ...
          INSERT INTO #jdbc_columns values (
            ...
            */
                ...
                */
                convert(smallint, 
                    substring('0111111', 
                        charindex(convert(char, @c_type), @char_bin_types)+1, 1)) * 
...
insert spt_mda values ('EXTRANAMECHARS', 2, 'select ''@#$ге''', 1, 3, 0, -1)
insert spt_mda values ('EXTRANAMECHARS', 6, '@#$ге', 4, 7, 0, -1)
...
create table #jproccols_res
    (PROCEDURE_CAT   varchar(32)  null,
     ...
     PROCEDURE_NAME  varchar(38)  not null,
